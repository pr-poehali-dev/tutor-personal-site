  ...
  const services = [
    {
      ...
      description: "Разбор всех типов заданий, решение задач повышенной сложности, практические тесты",
      icon: "BookOpen"
    },
    {
      title: "Подготовка к ЕГЭ",
      description: "Профильная математика: от базовых тем до сложных задач второй части",
      icon: "GraduationCap"
    },
    {
      title: "Школьная программа",
      description: "5-11 классы: алгебра, геометрия, помощь с домашними заданиями",
      icon: "User"
    }
  ];
  ...
  const prices = [
    {
      ...
      price: "1500 ₽",
      duration: "60 минут",
      features: ["5-11 классы", "Помощь с домашними заданиями", "Подготовка к контрольным"]
    },
    {
      title: "Подготовка к ОГЭ",
      price: "2000 ₽",
      duration: "90 минут",
      features: ["Разбор всех типов заданий", "Практические тесты", "Индивидуальная программа"]
    },
    {
      title: "Подготовка к ЕГЭ",
      price: "2500 ₽",
      duration: "90 минут",
      features: ["Профильная математика", "Задачи второй части", "Стратегия сдачи экзамена"]
    }
  ];
